...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="./ventas">
            <div class="sidebar-brand-icon rotate-n-15">
                <i class="fas fa-crown"></i>
            </div>
            <div class="sidebar-brand-text mx-2">Los Reyes<sup> SIC</sup></div>
        </a>
        ...
        <li class="nav-item" style="display:<?php echo $_SESSION["perfil"] == 1 || $_SESSION["perfil"] == 2 ? 'block' : 'none';?>" id="elem_inventarios">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Deseo ir A:</h6>
                    <a class="collapse-item" href="./inventarios">Ingresar Inventario</a>
                    <a class="collapse-item" href="./alta-de-inventarios">Ingresar Alta de Inventario</a>
                    <a class="collapse-item" href="./productos-en-stock">Reporte de Stock</a>
                    <a class="collapse-item" href="./reportes-inventarios">Reporte de Inventario</a>
        ...
        <li class="nav-item" style="display:<?php echo $_SESSION["perfil"] == 1 || $_SESSION["perfil"] == 4 ? 'block' : 'none' ;?>"">
            ...
            <div id="collapseCaja" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Deseo ir A:</h6>
                    <a id="elem_caja" class="collapse-item" href="./caja">Ingresar Inicio de Caja</a>
                    <a id="elem_caja" class="collapse-item" href="./gastos">Ingresar Egreso(s)</a>
                    <a id="elem_caja" class="collapse-item" href="./reportes-caja">Reporte de Caja General</a>
        ...
        <div class="sidebar-card d-none d-lg-flex">
            ...
            <p class="text-center mb-2"><strong>SIC</strong> Sistema Control de Inventario</p>
            <a class="btn btn-success btn-sm" href="https://startbootstrap.com/theme/sb-admin-pro">Version 1.1.1</a>
        </div>
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <form
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..." hidden="hidden"
                               aria-label="Search" aria-describedby="basic-addon2">
                        <div class="input-group-append">
                            <button class="btn btn-primary" type="button" hidden="hidden">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php inicia_sesion_segura();
                                echo $_SESSION["nombre_de_usuario"] . " ";
                                echo (intval($_SESSION["administrador"]) === 1) ? '<i class="fa fa-unlock"></i>' : '<i class="fa fa-lock"></i>'; ?></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a href="./modulos/usuarios/cerrar_sesion.php" class="dropdown-item" ">
